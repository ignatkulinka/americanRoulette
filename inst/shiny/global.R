...
rouletteTable <- matrix(1:36, ncol = 3, byrow = T)
...
lineBets <- data.frame(x = c(rep(-1, 12),
                             rep(5, 12)),
                       y = c(seq(0, 22, 2),
                             seq(0, 22, 2)),
                       b1 = rep(seq(34, 1, -3), 2),
...
streetBets <- data.frame(x = c(rep(-1, 11),
                               rep(5, 11)),
                         y = c(seq(1, 21, 2),
                               seq(1, 21, 2)),
                         b1 = rep(seq(31, 1, -3), 2),
...
#the first row of outside bets: 1to18, Even, Red, Black, Odd, 19to36
